...
droplet11.shapeColor = "darkgreen"
...
for(var i = 300;i < 1990;i = i+50){
    
   var droplets = createSprite(i,50,5,15)
   droplets.velocityY = 5
   droplets.shapeColor = "red"
   droplets.collide(invisibleGround)
}
for(var i = 700;i < 1990;i = i+50){
    
    var droplets = createSprite(i,50,5,15)
    droplets.velocityY = 5
    droplets.shapeColor = "blue"
    droplets.collide(invisibleGround)
 }
drawSprites()
}